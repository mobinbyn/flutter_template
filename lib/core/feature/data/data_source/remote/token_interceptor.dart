...
class TokenInterceptor extends Interceptor {
  ...
  Future<void> _refreshToken(DioException err, ErrorInterceptorHandler handler) async {
    ...
    TokenModel tokenModel = TokenModel(
      accessToken: await _authenticationService.getToken() ?? '',
      refreshToken: await _authenticationService.getRefreshToken() ?? '',
    );
    ...
    response.fold(
      ...
      (token) async {
        ...
        _authenticationService.persistToken(token.accessToken, token.refreshToken);
